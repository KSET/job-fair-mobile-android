...
class WorkshopsCompanyMapperShould {

    private lateinit var mapper: WorkshopsCompanyMapper

    private var companyResource: WorkshopsQuery.Company? = null

    private lateinit var company: Company
    @Mock private lateinit var companyLogoMapper: WorkshopsCompanyLogoMapper
    @Mock private lateinit var expectedCompanyLogo: Image
    @Mock private lateinit var companyLogoResource: WorkshopsQuery.Logo

    @Before
    fun prepare() {
        mapper = WorkshopsCompanyMapper(companyLogoMapper)
